                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="slider_text ">
                            ...
                            <h3>Signup and Login to Apply the Available Aid</h3>
                            <a href="<?= base_url('signup') ?>" class="boxed-btn3">Signup
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-55">
                        <h3><span>Available Aid Application</span></h3>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                                <img src="img/help/laptop.jpeg" alt="">
                            </div>
                        </div>
                        <div class="help_content">
                            <h4>Laptop Aid</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        ...
                        <div class="help_content">
                            <h4>Provisions for the maintenance of mosques/suraus or schools</h4>
                            <p>Lorem ipsum, or lipsum as it is 
                                sometimes known, is dummy 
                                text used in laying out print.</p>
                        </div>
                ...
                <div class="col-lg-7">
                    <div class="activites_info">
                        <div class="section_title">
                            <h3> <span>The Importance of Charity Activities</h3></span><br>
                        ...
                        <a href="<?= base_url('indexdonate') ?>"  class="boxed-btn4">Donate Now</a>   
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="img/volenteer/3.jpg" alt="">
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            ...
                            <p class="address_text">To address and alleviate social,economic, <br>   environmental, or humanitarian issues <br> by implementing projects and programs that contribute to positive and sustainable change in communities.
