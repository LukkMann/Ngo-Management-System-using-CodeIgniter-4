...
<div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" method="post" action="submit-edit-provision">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="nama_masjid" class="form-control" required value="<?= $provisionData['nama_masjid'] ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="mukim" class="form-control" value="<?= $provisionData['mukim'] ?>" required/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="alamat" class="form-control"><?= $provisionData['alamat'] ?></textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="status_tanah" class="form-control" value="<?= $provisionData['status_tanah'] ?>" required/>
                  </div>
                </div>
              </div> 
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="no_lot" class="form-control" value="<?= $provisionData['no_lot'] ?>" required/>
                </div>
              </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="nama_mohon_servis" class="form-control" value="<?= $provisionData['nama_mohon_servis'] ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="jawatan" class="form-control" value="<?= $provisionData['jawatan'] ?>"/>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="no_fon" class="form-control" value="<?= $provisionData['no_fon'] ?>" required/>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="acc_masjid" class="form-control" value="<?= $provisionData['acc_masjid'] ?>" required/>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="nama_bank" class="form-control" value="<?= $provisionData['nama_bank'] ?>" required/>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="nama_acc" class="form-control" value="<?= $provisionData['nama_acc'] ?>" required/>
                  </div>
                </div>
              </div> 
