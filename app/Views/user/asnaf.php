...
<div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" method="post" action="addasnaf">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="kad_pengenalan" class="form-control" required/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="no_bimbit" class="form-control" />
                      </div>
                    </div>
                  </div> 
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select  class="form-control"  name="kesihatan">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="hurai" class="form-control" ></textarea>
                  </div>
                </div>
            </div>
         </div>
          ...
          <p class="card-description">Bank Information</p>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="nama_pemegang" class="form-control" />
                  </div>
                </div>
              </div> 
