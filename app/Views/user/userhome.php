                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="slider_text ">
                            ...
                            <h3> Join The Movement To Help The Community To Be More Success</h3>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                            <a href="<?= base_url('asnaf') ?>">
                                <img src="img/help/2.png" alt="Description of the image">
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                            <a href="<?= base_url('computer') ?>">
                                <img src="img/help/laptop.jpeg" alt="Description of the image">
                                </a>
                            </div>
                        </div>
                        <div class="help_content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            ...
                            <div class="thum_1">
                            <a href="<?= base_url('provision') ?>">
                                <img src="img/help/3.png" alt="Description of the image">
                                </a>
                            </div>
                        </div>
                        <div class="help_content">
