...
<div class="card">
  <div class="card-body">
  <div class="table-responsive">
    <h2>Provision Service Aid List</h2>
        ...
        <div class="tab-content mt-2">
            <div class="tab-pane fade show active" id="content1">
                <h3>In Process Provision Service Aid List</h3>
                <!-- DataTable for Tab 1 -->
    ...
    <?php if ($provisions): ?>
      ...
      <?php foreach ($provisions as $provision): ?>
          <?php if ($provision['pe_status'] === 'In Process'): ?>
              <tr>
                  <td><?php echo $counter; ?></td>
                  <td><?php echo $provision['nama_masjid']; ?></td>
                  <td><?php echo $provision['no_fon']; ?></td>
                  <td><label class="badge badge-warning"><?php echo $provision['pe_status']; ?></label></td>
                  <td><?php echo $provision['pe_date']; ?></td>
                  <td><?php echo $provision['duit_pe']; ?></td>
                  <td>
                      <a href="<?php echo base_url('admin/detail-provision/'.$provision['pe_id']);?>" class="btn btn-outline-info btn-fw">View</a>
                  ...
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              ...
                              <a href="<?php echo base_url('delete-provision/'.$provision['pe_id']);?>"  class="btn btn-danger">Delete</a>
                          </div>
                      </div>
                  </div>
              </div>
    ...
    <?php if ($provisions): ?>
      <?php $counter = 1; ?>
      <?php foreach ($provisions as $provision): ?>
          <?php if ($provision['pe_status'] === 'Reject'): ?>
              <tr>
                  <td><?php echo $counter; ?></td>
                  <td><?php echo $provision['nama_masjid']; ?></td>
                  <td><?php echo $provision['no_fon']; ?></td>
