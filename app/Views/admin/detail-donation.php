        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Detail Donation</h4>
                  <p class="card-description">
                  </p>
                  <form class="forms-sample" method="post" action="">
                  <input type="hidden" name="sum_id"  value="<?= $donationData['sum_id'] ?>">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Full Name</label>
                      <input type="text" name="username" class="form-control" id="exampleInputUsername1"  value="<?= $donationData['nama'] ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Email address</label>
                      <input type="email" name="email" class="form-control" id="exampleInputEmail1"  value="<?= $donationData['email'] ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">IC/Passport Number</label>
                      <input type="text" name="password" class="form-control" id="exampleInputPassword1"  value="<?= $donationData['ic'] ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Phone Number</label>
                      <input type="text" name="password" class="form-control" id="exampleInputPassword1"  value="<?= $donationData['phone_number'] ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Amount</label>
                      <input type="text" name="password" class="form-control" id="exampleInputPassword1"  value="<?= $donationData['amount'] ?>" disabled>
                    </div>


                    <div class="form-group">
                      <label for="exampleInputPassword1">Donation Date</label>
                      <input type="text" name="register_date" class="form-control" id="exampleInputPassword1"  value="<?= $donationData['donate_date'] ?>" disabled>          
                      </div>

                    <a href="<?= site_url('admin/donation-list') ?>"  class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
