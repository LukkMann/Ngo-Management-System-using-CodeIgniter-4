...
<?php endif; ?>
        ...
        <div class="row">
            <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Form Laptop Status</p>
    ...
    <h2>Laptop Aid List</h2>
        ...
        <div class="tab-content mt-2">
            <div class="tab-pane fade show active" id="content1">
                <h3>In Process Laptop Aid List</h3>
                <!-- DataTable for Tab 1 -->
            ...
            <th>Action</th>
                  ...
                  <?php if ($computers): ?>
                      ...
                      <?php foreach ($computers as $computer): ?>
                          <?php if ($computer['kom_status'] === 'In Process'): ?>
                              <tr>
                                  <td><?php echo $counter; ?></td>
                                  <td><?php echo $computer['kom_nama']; ?></td>
                                  <td><?php echo $computer['kom_noic']; ?></td>
                                  <td><label class="badge badge-warning"><?php echo $computer['kom_status']; ?></label></td>
                                  <td><?php echo $computer['kom_date']; ?></td>
                                  <td><?php echo $computer['duit_kom']; ?></td>
                                  <td>
                                      <a href="<?php echo base_url('admin/detail-computer/'.$computer['kom_id']);?>" class="btn btn-outline-info btn-fw">View</a>
                                  ...
                                  <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <a href="<?php echo base_url('delete-computer/'.$computer['kom_id']);?>"  class="btn btn-danger">Delete</a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
            ...
            <div class="tab-pane fade" id="content2">
                <h3>Successfull Laptop Aid List</h3>
                <!-- DataTable for Tab 2 -->
            ...
            <th>Action</th>
                    ...
                    <tbody>
                        <?php if ($computers): ?>
                            <?php $counter = 1; ?>
                            <?php foreach ($computers as $computer): ?>
                                <?php if ($computer['kom_status'] === 'Reject'): ?>
                                    <tr>
                                        <td><?php echo $counter; ?></td>
                                        <td><?php echo $computer['kom_nama']; ?></td>
                                        <td><?php echo $computer['kom_noic']; ?></td>
