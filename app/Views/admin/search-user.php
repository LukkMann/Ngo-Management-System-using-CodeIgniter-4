        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <form id="searchForm" method="get" action="search-user">
                      ...
                      <?php foreach ($users as $user): ?>
                        ...
                        <td colspan="3">
                          <?php if ($user['level_id'] ==='1'): ?>
                            <a href="<?php echo base_url('admin/detail-user/'.$user['user_id']);?>" class="btn btn-outline-info btn-fw">View</a>
                            <?php else: ?>
                            <a href="<?php echo base_url('admin/detail-user/'.$user['user_id']);?>" class="btn btn-outline-info btn-fw">View</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url('delete-user/'.$user['user_id']);?>"  class="btn btn-danger">Delete</a>
