        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <form id="searchForm" method="get" action="search-computer">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Laptop Aid List</h4>
                  <p class="card-description">
                  List of user that Apply
                  </p>
                    ...
                    <?php if ($computers): ?>
                        ...
                        <?php foreach ($computers as $computer): ?>
                            <tr>
                                ...
                                <td><?= $computer['kom_nama']; ?></td>
                                <td><?= $computer['kom_noic']; ?></td>

                                <?php if (empty($computer)): ?>
                                    <td><label class="badge badge-info">Not Apply yet</label></td>
                                <?php else: ?>
                                    <?php if ($computer['kom_status'] === 'Successfull'): ?>
                                        <td><label class="badge badge-success"><?= $computer['kom_status']; ?></label></td>
                                    <?php elseif ($computer['kom_status'] === 'Reject'): ?>
                                        <td><label class="badge badge-danger"><?= $computer['kom_status']; ?></label></td>
                                    <?php else: ?>
                                        <td><label class="badge badge-warning"><?= $computer['kom_status']; ?></label></td>
                                    <?php endif; ?>
                                <?php endif; ?>

                                <td><?= $computer['kom_date']; ?></td>
                                <td><?= $computer['duit_kom']; ?></td>

                                <td colspan="3">
                                    <a href="<?= base_url('admin/detail-computer/'.$computer['kom_id']); ?>" class="btn btn-outline-info btn-fw">View</a>
                                    <button type="button" class="btn btn-outline-danger btn-fw" data-toggle="modal" data-target="#exampleModal<?= $computer['kom_id']; ?>">Delete</button>
                                </td>
                            </tr>

                            <div class="modal fade" id="exampleModal<?= $computer['kom_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?= base_url('delete-computer/'.$computer['kom_id']); ?>" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
