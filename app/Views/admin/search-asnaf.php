        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <form id="searchForm" method="get" action="search-asnaf">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Asnaf List</h4>
                      ...
                      <?php if ($asnafs): ?>
                          ...
                          <?php foreach ($asnafs as $asnaf): ?>
                              <tr>
                                  ...
                                  <td><?= $asnaf['nama_pemohon']; ?></td>
                                  <td><?= $asnaf['kad_pengenalan']; ?></td>

                                  <?php if (empty($asnaf)): ?>
                                      <td><label class="badge badge-info">Not Apply yet</label></td>
                                  <?php else: ?>
                                      <?php if ($asnaf['a_status'] === 'Successfull'): ?>
                                          <td><label class="badge badge-success"><?= $asnaf['a_status']; ?></label></td>
                                      <?php elseif ($asnaf['a_status'] === 'Reject'): ?>
                                          <td><label class="badge badge-danger"><?= $asnaf['a_status']; ?></label></td>
                                      <?php else: ?>
                                          <td><label class="badge badge-warning"><?= $asnaf['a_status']; ?></label></td>
                                      <?php endif; ?>
                                  <?php endif; ?>

                                  <td><?= $asnaf['as_date']; ?></td>
                                  <td><?= $asnaf['duit_asnaf']; ?></td>

                                  <td colspan="3">
                                      <a href="<?php echo base_url('admin/detail-asnaf/'.$asnaf['asnaf_id']);?>" class="btn btn-outline-info btn-fw">View</a>
                                      <button type="button" class="btn btn-outline-danger btn-fw" data-toggle="modal" data-target="#exampleModal<?= $asnaf['asnaf_id']; ?>">Delete</button>
                                  </td>
                              </tr>

                              <div class="modal fade" id="exampleModal<?= $asnaf['asnaf_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
